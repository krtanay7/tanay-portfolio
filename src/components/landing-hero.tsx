...
import TypingText from "./utility/typingtext";
          ...
          <AnimatePresence>
            ...
            <FadeUp key="description" duration={0.6} delay={0.2}>
             <div className="mt-8 max-w-3xl text-base font-semibold text-zinc-900 dark:text-zinc-200 sm:text-base md:text-xl">
                  I am a full-stack software developer focused on building scalable,
                  high-performance, and user-centric web applications. I work extensively
                  with{" "}
                  ...
                  <span className="font-semibold text-accent">Angular</span> on the frontend,
                  and build reliable backend systems using{" "}
                  ...
                  <span className="font-semibold text-accent">PostgreSQL</span>. I also have
                  hands-on experience with machine learning workflows, data preprocessing,
                  and visualization using{" "}
                  <span className="font-semibold text-accent">Python</span>,{" "}
                  <span className="font-semibold text-accent">Scikit-learn</span>,{" "}
                  <span className="font-semibold text-accent">Pandas</span>, and{" "}
                  <span className="font-semibold text-accent">Matplotlib</span>.
                </div>
